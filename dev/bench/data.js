    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "4760f46ba46177af8c640d8a0ace87b9c87a09a0",
          "message": "fix(release): track canonical version in workspace root package.json\n\nPreviously workspace root stayed at 0.0.0 (a marker version) while\npublishable packages tracked the shipped version. That made the\nrelease PR body read \"previous: v0.0.0\" because create-release-pr.yml\nread base from root via jq, and forced readCanonicalVersion() into a\n\"pick first publishable, assert lockstep\" pattern that was harder to\nreason about.\n\nNow bump writes root + publishable packages together, and\nreadCanonicalVersion reads root and asserts publishable packages\nmatch. Anyone inspecting the repo's root package.json sees the\ncurrent shipped version. The lockstep error message also gets\nclearer (lists `<root>` alongside named packages).\n\nBumps root to 0.2.0 to align with the current shipped state.\n\nCo-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-04-27T20:12:35.296Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/4760f46ba46177af8c640d8a0ace87b9c87a09a0"
        },
        "date": 1777320755296,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6f49a040e5e4700a495015f6b77b8233b32fdd2b",
          "message": "docs(release): mention GitHub Release step in rolling release PR body",
          "timestamp": "2026-04-27T20:19:00.731Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/6f49a040e5e4700a495015f6b77b8233b32fdd2b"
        },
        "date": 1777321140731,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "110c2a32ac1751d7ac3be91d0b318ec1be0e9631",
          "message": "chore(release): publish v0.3.0 (#18)\n\nCo-authored-by: mikrodroid[bot] <279549104+mikrodroid[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-27T20:23:09.786Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/110c2a32ac1751d7ac3be91d0b318ec1be0e9631"
        },
        "date": 1777321389786,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1fc499ad2bb5f973db69bdfecb765cf1c0717abd",
          "message": "fix(release): attribute release-side effects to mikrodroid[bot]\n\nPreviously the publish job's tag push, GitHub Release author, and\nPR-preview comments showed up as github-actions[bot] because we used\nsecrets.GITHUB_TOKEN. The rolling release PR was already authored by\nmikrodroid[bot] (via the App token), so the release outputs looked\ninconsistent — same effort, two identities.\n\nMints the mikrodroid App token at the top of both the plan and\npublish jobs, then routes:\n\n  - plan: unlabel-preview → App token (the only side effect)\n  - publish: checkout (for git push auth), tag, github-release,\n    comment-pr → App token\n\nThe plan command's read-only PR/commit lookup stays on GITHUB_TOKEN\n(no attribution issue, doesn't need the App round-trip). npm publish\nunchanged — still uses NODE_AUTH_TOKEN.\n\nCo-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-04-27T21:05:22.465Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/1fc499ad2bb5f973db69bdfecb765cf1c0717abd"
        },
        "date": 1777323922465,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "06a6c8a268b8d88157c515119286583b128ad7c0",
          "message": "chore(release): publish v0.3.1 (#19)\n\nCo-authored-by: mikrodroid[bot] <279549104+mikrodroid[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-27T21:07:35.553Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/06a6c8a268b8d88157c515119286583b128ad7c0"
        },
        "date": 1777324055553,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "882b32d6b558a3b23c52e400cbeb20978cb32083",
          "message": "refactor: update github app token auth and improve release asset handling",
          "timestamp": "2026-04-27T21:44:49.061Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/882b32d6b558a3b23c52e400cbeb20978cb32083"
        },
        "date": 1777326289061,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "24d01b764f9ecb8cfa0e40a5dfa65b96c7326f8c",
          "message": "chore(release): publish v0.3.2 (#20)\n\nCo-authored-by: mikrodroid[bot] <279549104+mikrodroid[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-27T21:47:55.339Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/24d01b764f9ecb8cfa0e40a5dfa65b96c7326f8c"
        },
        "date": 1777326475339,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "23a8ec2c0778529ef18cdc98bcadaaa427122d29",
          "message": "feat: add error state indicator and use cli version in simulator ready message",
          "timestamp": "2026-04-27T22:15:59.279Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/23a8ec2c0778529ef18cdc98bcadaaa427122d29"
        },
        "date": 1777328159279,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6a6dd2205160d5338401ef2b0a8f49824fc28f7f",
          "message": "chore(release): publish v0.4.0 (#21)\n\nCo-authored-by: mikrodroid[bot] <279549104+mikrodroid[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-27T22:24:19.864Z",
          "tree_id": "",
          "url": "https://github.com/mikrojs/mikrojs/commit/6a6dd2205160d5338401ef2b0a8f49824fc28f7f"
        },
        "date": 1777328659864,
        "tool": "customSmallerIsBetter",
        "benches": [
