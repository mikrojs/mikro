...
export class I2c implements SimI2c {
  ...
  scan() { return {ok: true as const, value: new Uint8Array()} }
  write(_address: number, _data: Uint8Array, _stop?: boolean) { return {ok: true as const} }
  read(_address: number, bytes: number) { return {ok: true as const, value: new Uint8Array(bytes)} }
}
`,
}
