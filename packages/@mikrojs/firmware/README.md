...
- **`project.cmake`** - CMake module that integrates with ESP-IDF. Resolves the native modules the project names into components, merges SDK config, and applies partition table defaults.
