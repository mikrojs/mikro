...
int main() {
     ...
     * cost. ESP-only modules (wifi, fetch, pwm, spi, i2c, uart, sntp,
     * sleep, kv, test) depend on `native:*` modules that only
    ...
    static const struct {
        ...
        {"+ result", "import {ok, err} from 'mikro/result'"},
        {"+ sys", "import {memoryUsage} from 'mikro/sys'"},
        {"+ stdio", "import {stdout} from 'mikro/stdio'"},
        {"+ cbor", "import {encode, decode} from 'mikro/cbor'"},
        {"+ schema", "import {object, string, number} from 'mikro/schema'"},
        {"+ env", "import {env} from 'mikro/env'"},
        ...
        {"+ pwm", "import {Pwm} from 'mikro/pwm'"},
        {"+ spi", "import {Spi} from 'mikro/spi'"},
        {"+ i2c", "import {I2c} from 'mikro/i2c'"},
        {"+ uart", "import {Uart} from 'mikro/uart'"},
        {"+ wifi", "import {wifi} from 'mikro/wifi'"},
        {"+ http/request", "import {request} from 'mikro/http/request'"},
