...
export function parseMinifier(value: string | undefined): Minifier | undefined {
  ...
  throw new UserError(`Invalid minifier '${value}'. Must be one of: esbuild, terser, swc`)
}
...
export function parseMinifyLevel(value: string | undefined): MinifyLevel | undefined {
  ...
  throw new UserError(`Invalid minify level '${value}'. Must be one of: default, max`)
}
...
export function parseLogLevel(value: string | undefined): LogLevel | undefined {
  ...
  throw new UserError(
    `Invalid log level '${value}'. Must be one of: none, error, warn, info, debug`,
  )
}
