...
- [EIM](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/get-started/index.html) (Espressif IDE Manager) with ESP-IDF >= 6.1 (for firmware builds)
...
For firmware builds, install ESP-IDF >= 6.1 via [EIM](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/get-started/index.html) before proceeding:
...
Make sure ESP-IDF >= 6.1 is installed (see [Prerequisites](#prerequisites)), then:
