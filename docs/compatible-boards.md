...
RAM is determined by the chip and module: 384-520 KB of internal SRAM, shared by the runtime, WiFi/BLE stacks, your app, and every loaded module. PSRAM variants (ESP32-S3, ESP32-C5, ESP32 WROVER) add external SPI memory in the same package, which lets larger apps use memory beyond the SRAM budget.
